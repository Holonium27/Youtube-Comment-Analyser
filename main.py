...
@app.route('/models')
def models():
    nb_score,svm_score,knn_score,score,bagging_score = 97.5609,96.747,75.609,90.243,97.5609
    values=[205,39,36]
    #nb_score,svm_score,knn_score,score,bagging_score,values = sentiment_analyzer()
    data = [ nb_score,svm_score,knn_score,score,bagging_score]
    labels = ['Naive Bayes', 'SVM', 'KNN', 'Random Forest', 'Bagging']
    labels2=['Positive','Negative','Neutral']
    positive_score=values[0]
    negative_score=values[1]
    neutral_score=values[2]
    if positive_score > negative_score and positive_score > neutral_score:
        phrase='Mostly Positive'
    elif negative_score > positive_score and negative_score > neutral_score:
        phrase='Mostly Negative' 
    elif neutral_score > positive_score and neutral_score > negative_score:
        phrase='Mostly Neutral'

    return render_template('index2.html', data=data,labels=labels,values=values,labels2=labels2, positive_score=positive_score,negative_score=negative_score,neutral_score=neutral_score, phrase=phrase)
...
def sentiment_analyzer():
    ...
    values=[]
    for i in processed_data['Sentiment'].value_counts():
        values.append(i)
    """### **Balancing data**"""
    ...
    return nb_score,svm_score,knn_score,score,bagging_score,values
